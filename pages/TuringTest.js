    ...
    <div>
      <Box sx={{ display: "flex" }}>
        ...
        <Box component="main" sx={{ flexGrow: 1, p: 3 }}>
          ...
          >
            <h2 style={{ marginLeft: "5rem", padding: "1rem" }}>
            ...
            <Box sx={{ width: 1000 }}>
              <span
                style={{ fontSize: 16, marginLeft: "5vh", fontWeight: 600 }}
              >
                Welcome to turing
              </span>
              <span
              ...
              <span
                style={{ fontSize: 16, marginLeft: "22vh", fontWeight: 600 }}
              >
                Pass your Test
              </span>
              <span
            ...
            <Container>
              <Row>
                <Col sm={8}>
                  ...
                  <Button variant="outlined" style={{bgcolor: "blue"}}>Continue</Button>
                </Col>
                <Col sm={4}>
                  <Container>
                    <Box
