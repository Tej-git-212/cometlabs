    ...
    <Box sx={{ display: "flex" }}>
      ...
      <AppBar position="fixed" open={open}>
        <Toolbar>
          ...
          <h1 style={{ marginLeft: "70vh" }}>CometLabs</h1>
        </Toolbar>
      </AppBar>
      <Drawer variant="permanent" open={open}>
        <DrawerHeader>
          <h2 style={{ marginRight: "80px", marginTop: "20px", fontSize: "25px", fontWeight: "bold"}}>Turing</h2>
          ...
          <ListItem>
            <ListItemIcon>
              <Button style={{ color: "inherit", marginLeft: "0px"}}>
                <WorkIcon />
                <span style={{ marginLeft: "24px" , padding:"6px", backgroundColor: "rgba(0,0,0,0.2)", borderRadius: "50px", fontSize: "12px"}}>Available for Jobs</span>
              </Button>
            </ListItemIcon>
          </ListItem>
          <ListItem>
